...
[_NL] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX,     XXXXXXX, KC_0,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
 ),
...
[_WL] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX,     XXXXXXX, HYP_ENT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
 ),
...
[_DM] = LAYOUT_planck_grid(
    XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, DM_REC1, DM_REC2, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, DM_PLY1, DM_PLY2, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX,     XXXXXXX, DM_RSTP, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
 ),
[_MS] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX,     XXXXXXX, KC_BTN1, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
 ),
...
[_SC] = LAYOUT_planck_grid(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, SECRET1, SECRET2, SECRET3,  XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX,     XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX
),
// NOTE quantum/process_keycode/process_midi.c
#ifdef MIDI_ENABLE
[_MD] = LAYOUT_planck_grid(
    ...
    MI_SUS,  MI_OCTD,  MI_OCTU, MI_MODSD, MI_MODSU, MI_ALLOFF, MI_ALLOFF, XXXXXXX,  MI_TRNS_0, MI_TRNSD, MI_TRNSU,  MI_SUS
),
#endif
};
...
layer_state_t layer_state_set_user(layer_state_t state) {
  return update_tri_layer_state(state, _NL, _WL, _SC);
}
...
void matrix_scan_user(void) {
    ...
    LEADER_DICTIONARY() {
        ...
        //     register_code(KC_SECRET_1);
        //     unregister_code(KC_SECRET_1);
        // }
        /* // Kamoji section */
